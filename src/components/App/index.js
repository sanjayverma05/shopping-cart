...
const SelectItemView = (props) => (
  <LazyLoad
    load={() =>
      import(
        /* webpackChunkName: "lazyload-SelectView", webpackPreload: true */ "Components/SelectView"
      )
    }
  >
    {(Component) =>
...
const CheckoutView = (props) => (
  <LazyLoad
    load={() =>
      import(
        /* webpackChunkName: "lazyload-Checkout", webpackPrefetch: true */ "Components/Checkout"
      )
    }
  >
    {(Component) =>
        ...
        <Router>
          ...
          <Switch>
            <Route
              exact
              path="/checkout"
              render={() => <CheckoutView selectedItems={selectedItems} />}
            />
            <Route
              exact
              path="/"
              render={() => (
                <SelectItemView items={items} addItemsToCart={addItemsToCart} />
              )}
            />
          </Switch>
        </Router>
